...
const divStyle = (screenClass) => {
  if (screenClass === 'xl') {return { width: '700px',margin:"40% auto auto" };}
  if (screenClass === 'lg') {return { width: '600px',margin:"40% auto auto"};}
  if (screenClass === 'md') {return { width: '600px',margin:"40% auto auto" };}
  if (screenClass === 'sm') {return { width: '600px',margin:"40% auto auto" };}
